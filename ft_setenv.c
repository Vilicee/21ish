...
/*   Updated: 2021/10/05 13:57:06 by wvaara           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_add_variables(t_shell *data, char *new_var, char *value)
{
	char	**temp;
	char	*word;
	int		len;
...
static void	ft_mod_variable(int ret, char *type, char *value, t_shell *data)
{
	char	*word;
